...
The current template release is `v1.0.2`. Both application services build `tech-progress/railway-template-vendure` from `release-v1`; dependency images and the Node base are immutable digest pins.
